...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-7 h-7 flex items-center justify-center rounded-md border border-gray-200 dark:border-zinc-700 text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-zinc-100 hover:border-gray-400 dark:hover:border-zinc-500 transition-colors"
    >
      {theme === 'dark' ? (
